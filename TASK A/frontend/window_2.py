from PyQt6.QtWidgets import QMainWindow,QLabel,QVBoxLayout,QHBoxLayout,QWidget,QComboBox,QCheckBox,QPushButton
...
class SecondWindow(QMainWindow):
    def __init__(self):
        ...
        self.create_workout_button.setStyleSheet("background-color: blue; color: white; font-size: 20px;")
        self.button_layout.addWidget(self.create_workout_button, alignment=Qt.AlignmentFlag.AlignRight)
